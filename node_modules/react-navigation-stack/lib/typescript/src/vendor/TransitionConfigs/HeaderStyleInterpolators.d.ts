import { StackHeaderInterpolationProps, StackHeaderInterpolatedStyle } from 'react-navigation-stack/lib/typescript/src/vendor/types';
/**
 ...
 */
export declare function forSlide({ current, next, layouts: { screen }, }: StackHeaderInterpolationProps): StackHeaderInterpolatedStyle;
